...
const LandingPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://6480432af061e6ec4d48ebcc.mockapi.io/article-home?page=1&limit=3");
    ...
    <div id="home">
      ...
      <div className="container mx-auto mt-16 p-8 text-center">
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          {/* Kotak Pelayanan 1 */}
          <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8" data-aos="zoom-in" data-aos-duration="1000">
          ...
          {/* Kotak Pelayanan 3 */}
          <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8 sm:ml-auto sm:mr-auto" data-aos="zoom-in" data-aos-duration="1000">
            <div className="border-2 rounded-lg border-[#080C71] bg-[#f6f9ff] overflow-hidden flex items-center justify-center flex-col text-center">
              <img
                src={artikel}
                alt="Konsultasi Online"
      ...
      {/* Section KENALAN */}
      <div className="container mx-auto flex flex-col rounded-lg max-w-screen-xl sm:flex-row items-center justify-between bg-[#D8EEFE] dark:bg-gray-900 py-14 mb-16" data-aos="fade-up"
        data-aos-duration="2000">
        ...
        <div className="sm:w-1/2 lg:w-2/3">
          <h2 className="text-3xl font-bold mb-4 text-[#296fde]">Kenalan sama kita yuk!</h2>
          <p className="text-gray-700 dark:text-gray-400 mb-6">
            <span className="font-bold">Dear Sobat Sehat,</span> SehatPlus adalah penyedia layanan kesehatan online yang menawarkan solusi kesehatan dan saran kepada lebih dari 30.000 pasien di seluruh Indonesia.
            Dengan tim dokter dan farmasi berlisensi, SehatPlus bertujuan untuk menyediakan layanan konsultasi medis komprehensif bagi pasien.
          </p>
          <p className="text-gray-700 dark:text-gray-400 mb-6">
            Kami hadir dengan layanan yang mencakup konsultasi medis online, pengiriman obat-obatan, serta informasi kesehatan terkini melalui platform kami yang mendukung anda dalam menuju perjalanan hidup sehat yang lebih baik.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto mt-16 p-8 text-center">
        ...
        <div className="mt-8">
          <Link to="/artikel" className="inline-block px-4 py-2 bg-blue-700 text-white font-medium rounded-md transition duration-300 hover:bg-blue-800 focus:outline-none focus:ring focus:border-blue-300">
            Artikel Lainnya
          </Link>
        </div>
